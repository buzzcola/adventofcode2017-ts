const BIG_PROBLEM: string = '525544371475555531777715244182678432191828'; // truncated

function solve(input: string, offset:number) {
    let digits: number[] = Array.from(input).map(c => +c);
